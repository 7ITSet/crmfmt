    ...
    $.fn.uploadFile = function (options) {
	   ...
	   this.startUpload = function () {
		...
		function defaultProgressBar(obj,s)
		{
			...
			/* this.controls = $("<div class='ajax-file-upload-controls'></div>").appendTo(this.statusbar);
			this.turnLeft = $("<a class='btn btn-default txt-color-blue turnLeft'><i class='fa fa-rotate-left'></i></a>").appendTo(this.controls);
			this.crop = $("<a class='btn btn-default txt-color-blue crop'><i class='fa fa-crop'></i></a>").appendTo(this.controls);
			this.turnRight = $("<a class='btn btn-default txt-color-blue turnRight'><i class='fa fa-rotate-right'></i></a>").appendTo(this.controls); */
           
			this.progressbar = $("<div class='ajax-file-upload-bar'></div>").appendTo(this.progressDiv);
			
			this.main = $("<label class='checkbox ajax-file-upload-info' style='display:none;margin-top:8px;'><input type='checkbox' name='m_products_foto_main[]' value='"+id.substr(2)+"'/><i></i>Основное фото</label>").appendTo(this.statusbar);
