...
(function ($) {
    if($.fn.ajaxForm == undefined) {
        $.getScript("/js/plugin/fileuploader/jquery.form.js");
    }
    var feature = {};
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            dragDropStr: "<span><b>Перетащите сканы сюда</b></span>",
            uploadStr:"Загрузить",
            abortStr: "Прервать загрузку",
            cancelStr: "Отменить",
            deletelStr: "Удалить",
            doneStr: "Готово",
            multiDragErrorStr: "Multiple File Drag &amp; Drop is not allowed.",
            extErrorStr: "Можно загрузить только файлы с расширением: ",
            duplicateErrorStr: "Файл уже существует.",
            sizeErrorStr: "Максимальный размер файла: ",
            uploadErrorStr: "Произошла ошибка во время загрузки",
            maxFileCountErrorStr: "Максимальное количество файлов:",
        ...
        var uploadLabel = $('<button class="btn btn-primary" id="fileuploader"><i class="fa fa-file-image-o"></i>'+s.uploadStr+'</button>');
            ...
            if($.fn.ajaxForm) {
                ...
                $(obj).append(obj.errorLog);
   				...
   				if(s.showQueueDiv)
		            ...
		            obj.container = $("<div class='ajax-file-upload-container docs-upload'></div>").insertAfter($(obj));
	   ...
	   this.startUpload = function () {
		...
		function defaultProgressBar(obj,s)
		{
			...
			this.preview = $("<div class='ajax-file-upload-preview doctype'></div>").width(s.previewWidth).height(s.previewHeight).appendTo(this.previewContainerDiv).hide();
            this.progressDiv = $("<div class='ajax-file-upload-progress'>").appendTo(this.statusbar).hide();
            this.filetype = $("<a class='filetype' href='#' target='_blank'></a>").appendTo(this.statusbar);
			
			this.progressbar = $("<div class='ajax-file-upload-bar'></div>").appendTo(this.progressDiv);
			
			this.info = $("<div class='fileinfo'></div>").appendTo(this.statusbar);
			this.filename = $("<div class='ajax-file-upload-filename'></div>").appendTo(this.info);
			this.remove = $("<a class='ajax-file-upload-remove btn btn-default btn-lg txt-color-red' title='Удалить документ'><i class='fa fa-trash-o'></i></a>").appendTo(this.info);
			
            this.idVal=$("<input type='hidden' name='m_documents_scan[]' value='"+id.substr(2)+"'/>").appendTo(this.info);
