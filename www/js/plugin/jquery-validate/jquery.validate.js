...
(function ($) {
    ...
    $.extend($.validator, {
        ...
        messages: {
			...
			remote:"Укажите другие данные",
			email:"Укажите корректный email",
			url:"Укажите корректный URL",
			date:"Укажите корректную дату",
			dateISO:"Укажите дату в формате ISO",
			number:"Возможен ввод только чисел",
			digits:"Возможен ввод только цифр",
			creditcard:"Укажите корректный номер банковской карты",
			equalTo:"Значение не совпадает с вышеуказанным",
			maxlength:$.validator.format("Длина поля — не более {0} символов"),
			minlength:$.validator.format("Длина поля — не менее {0} символов"),
			rangelength:$.validator.format("Длина поля должна быть от {0} до {1} символов"),
			range:$.validator.format("Значение должно быть в диапазоне от {0} до {1}"),
			max:$.validator.format("Значение должно быть не более {0}"),
			min:$.validator.format("Значение должно быть не менее {0}")
        },
