var replace='';
jQuery.fn.sug_units = function(o) {
	// параметры по умолчанию
	var o = $.extend({  
		// URL для поиска слов
		url:'/ajax/suggest_units.php',
		//поле для подстановки значения
		idValue:'m_orders_smeta_services_unit_id[]',
		...
		wordClick:function(input,link){
			...
			unitId=link.attr('data-unit');
			input.parents('div.row:first').find("input[name='"+o.idValue+"']").val(unitId);
