...
$(document).ready(function(){
    var otable = $('#datatable_sales_return').DataTable({
		 "order": [[5,"asc"]]
    });
    $("#datatable_sales_return thead th input[type=text]").on( 'keyup change', function () {
        otable
							...
							<div class="jarviswidget jarviswidget-color-blue" id="wid-id-1" data-widget-editbutton="false" data-widget-colorbutton="false" data-widget-deletebutton="false">
								...
								<div>				
									...
									<div class="widget-body no-padding">
										...
										<table id="datatable_sales_return" class="table table-striped table-bordered table-hover" width="100%">
...
$confirm=array(0=>'отменён',1=>'в обработке',2=>'исполнен');										
if($t_history=$terminal->history('return',100000))
