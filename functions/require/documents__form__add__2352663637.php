...
if(get('m_documents_id')){
	...
	foreach($documents->getInfo() as $_document)
		if($_document[0]['m_documents_order']==$order['m_orders_id']&&$_document[0]['m_documents_templates_id']==2352663637)
			$acts[]=$_document[0];
...
<input type="hidden" name="m_documents_templates_id" value="2352663637"/>
<?
}
														/* НОВЫЙ */
else{
