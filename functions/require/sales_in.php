...
$(document).ready(function(){
    var otable = $('#datatable_sales_in').DataTable({
		 "order": [[5,"asc"]]
    });
    $("#datatable_sales_in thead th input[type=text]").on( 'keyup change', function () {
        otable
							...
							<div class="jarviswidget jarviswidget-color-blue" id="wid-id-1" data-widget-editbutton="false" data-widget-colorbutton="false" data-widget-deletebutton="false">
								...
								<div>				
									...
									<div class="widget-body no-padding">
										...
										<table id="datatable_sales_in" class="table table-striped table-bordered table-hover" width="100%">
...
if($t_history=$terminal->history('bonus',100000))
