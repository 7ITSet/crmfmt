...
<fieldset>
	...
	<div class="row">
		...
		<section class="col col-3">
			<label class="label">Предоплата на материалы</label>
			<label class="input">
				<i class="icon-append">₽</i>
				<input type="text" name="m_documents_doc_sum_pre_m" placeholder="фиксированная" style="text-align:right" value="<?=$document['params']->m_documents_doc_sum_pre_m?>">
			</label>
		</section>
		<section class="col col-3">
...
<input type="hidden" name="m_documents_templates_id" value="4022369853"/>
...
<fieldset>
	...
	<div class="row">
		<section class="col col-3">
			...
			<label class="input">
				<i class="icon-append">₽</i>
				<input type="text" name="m_documents_doc_sum_pre_m" placeholder="фиксированная" style="text-align:right">
			</label>
		</section>
		<section class="col col-3">
			<label class="label">Сумма предоплаты</label>
